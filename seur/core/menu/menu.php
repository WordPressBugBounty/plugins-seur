...
require_once SEUR_PLUGIN_PATH . 'core/pages/seur-settings.php';
require_once SEUR_PLUGIN_PATH . 'core/pages/about.php';
require_once SEUR_PLUGIN_PATH . 'core/pages/seur-nomenclator.php';
require_once SEUR_PLUGIN_PATH . 'core/pages/seur-rates.php';
...
require_once SEUR_PLUGIN_PATH . 'core/pages/rates/seur-delete.php';
require_once SEUR_PLUGIN_PATH . 'core/pages/rates/seur-update.php';
